//
//  HybridAVPlayerViewController.m
//  TestAVPlayer
//
...
@interface HybridAVPlayerViewController () <AVPictureInPictureControllerDelegate>
...
@implementation HybridAVPlayerViewController
...
-(IBAction)pipButtonTapped:(UIButton*)sender {
    if([AVPictureInPictureController isPictureInPictureSupported] == NO) {
        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"Not Supported"
                                                       message:@"This device does not support PictureInPicture function." delegate:self
    ...
    if (self.pipController.pictureInPictureActive == YES) {
